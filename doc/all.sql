...
insert into `doc` (id, ebook_id, parent, name, sort, view_count, vote_count, collection_count) values (1, 1, 0, '文档1', 1, 0, 0, 0);
insert into `doc` (id, ebook_id, parent, name, sort, view_count, vote_count, collection_count) values (2, 1, 1, '文档1.1', 1, 0, 0, 0);
insert into `doc` (id, ebook_id, parent, name, sort, view_count, vote_count, collection_count) values (3, 1, 0, '文档2', 2, 0, 0, 0);
insert into `doc` (id, ebook_id, parent, name, sort, view_count, vote_count, collection_count) values (4, 1, 3, '文档2.1', 1, 0, 0, 0);
insert into `doc` (id, ebook_id, parent, name, sort, view_count, vote_count, collection_count) values (5, 1, 3, '文档2.2', 2, 0, 0, 0);
insert into `doc` (id, ebook_id, parent, name, sort, view_count, vote_count, collection_count) values (6, 1, 5, '文档2.2.1', 1, 0, 0, 0);
